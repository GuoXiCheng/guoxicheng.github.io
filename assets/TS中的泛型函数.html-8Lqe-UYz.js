import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as a,b as e}from"./app-smAU8_4e.js";const t={},p=e(`<h1 id="ts-中的泛型函数" tabindex="-1"><a class="header-anchor" href="#ts-中的泛型函数" aria-hidden="true">#</a> TS 中的泛型函数</h1><h2 id="keyof" tabindex="-1"><a class="header-anchor" href="#keyof" aria-hidden="true">#</a> keyof</h2><p>用于获取一个类型的所有属性键的联合类型。作用于类型。</p><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">interface</span> <span class="token class-name">Person</span> <span class="token punctuation">{</span>
