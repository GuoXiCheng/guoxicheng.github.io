import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as a,a as e}from"./app-306MGlw9.js";const t={},p=e(`<h1 id="函数柯里化" tabindex="-1"><a class="header-anchor" href="#函数柯里化" aria-hidden="true">#</a> 函数柯里化</h1><p>函数柯里化是一种将接收多个参数的函数转化成多个接收一个参数的函数的过程，这些接收一个参数的函数称为“柯里化函数”。它们依次返回下一个柯里化函数，直至返回最终结果。</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// 非柯里化函数</span>
