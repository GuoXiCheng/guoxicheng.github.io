...
<generatorConfiguration>
    ...
    <context id="default" targetRuntime="MyBatis3">
        ...
        <javaModelGenerator targetPackage="com.guoxicheng.light_mall_back.pojo" targetProject="./src/main/java">
        ...
        <javaClientGenerator type="XMLMAPPER" targetPackage="com.guoxicheng.light_mall_back.dao" targetProject="./src/main/java">
...
```
### 3.datasource.properties配置文件
```
db.driverLocation=C:/mysql-connector-java-8.0.19.jar
db.driverClassName=com.mysql.cj.jdbc.Driver
db.url=jdbc:mysql://localhost:3306/light_mall
db.username=root
db.password=123456
