import{_ as c}from"./plugin-vue_export-helper-c27b6911.js";import{r as p,o as l,c as i,e as u,w as a,b as r,f as s,d as n}from"./app-9ea6e638.js";const k={},d=r(`<h1 id="装饰模式" tabindex="-1"><a class="header-anchor" href="#装饰模式" aria-hidden="true">#</a> 装饰模式</h1><h2 id="typescript自定装饰器" tabindex="-1"><a class="header-anchor" href="#typescript自定装饰器" aria-hidden="true">#</a> Typescript自定装饰器</h2><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">export</span> <span class="token keyword">function</span> <span class="token function">clock</span><span class="token punctuation">(</span>message <span class="token operator">=</span> <span class="token string">&#39;run time&#39;</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
